import { CFG, ST, SYMBOLS } from '../core/state.js';
import { log } from '../core/utils.js';
import { setConnUI, updateLivePriceUI, setView, refreshNewsUI } from '../store/uiState.js';
import { M5_STATE, pushM5Candle } from '../core/modules/m5Override.js';
import { initChart, seedChartData, pushChartUpdate, updateChartOHLC, setActiveTradeLines } from './chart.js';
import { buildCalendar, trackPastImpacts } from '../core/calendar.js';
import { computeBaseIndicators, checkBarCloseExits, checkIntraBarExits, runSignalEvaluation, onM5CandleClose, restoreActiveTrade } from '../core/engine.js';
...
// setConnUI / updateLivePriceUI are imported from the UI store (they used to
// write to DOM here; now they update reactive state). See store/uiState.js.
